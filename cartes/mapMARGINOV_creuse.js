...
+'<div  style="margin : auto auto auto 6px;">Les bassins de vie <br/>hyper-ruraux<br/>(<a href="https://hal.archives-ouvertes.fr/hal-00911232"  target="_blank">Hilal et al., 2011</a> ;<br/><a href="https://www.vie-publique.fr/rapport/34216-hyper-ruralite-un-pacte-national-en-6-mesures-et-4-recommandations"  target="_blank">Bertrand, 2014</a>)</div>'
+'</div>';
	return div;
}
	...
	pointToLayer: function(feature, latlng)
		{
			...
			marker.bindPopup('<h4>'+ feature.properties.type +' : <br/>' + feature.properties.nom_site + '</h4><p></p><p><b>Date de réalisation</b>: '+testNonNull (feature.properties.date)+'</p><b>Adresse </b>: '+testNonNull (feature.properties.adresse) +'<br/>'+testNonNull (feature.properties.commune)+' ('+testNonNull (feature.properties.cp)+')<p><a href="' + testNonNull (feature.properties.web) + '"  target="_blank" >'+testNonNull (feature.properties.web)+'</a></p><p> <strong>Informations :</strong></p><div> '+testNonNull (feature.properties.description)+'</div>');
